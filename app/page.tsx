...
// --- Ikon SVG dengan Tipe untuk TypeScript ---
...
const PuzzleIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M14 7V5a2 2 0 0 0-2-2H4a2 2 0 0 0-2 2v10a2 2 0 0 0 2 2h4v2a2 2 0 0 0 2 2h2a2 2 0 0 0 2-2v-2a2 2 0 0 0-2-2h-2v-2a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2a2 2 0 0 0 2 2h2a2 2 0 0 0 2-2v-4a2 2 0 0 0-2-2h-4a2 2 0 0 1-2-2z"/></svg>
);
const HandshakeIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M14.5 16.5 12 14l-2.5 2.5"/><path d="m2 14 3-3 3 3"/><path d="M13 22V14l-2.5-2.5-3 3-2-2-3-3-3 3 3 3 2 2 3-3"/><path d="M19 14V8l-3-3-3 3"/><path d="m22 12-3-3-3 3"/></svg>
);
...
const AnimatedSection = ({ children, className = "" }: { children: React.ReactNode, className?: string, id?: string }) => {
    ...
    return (
        <section ref={ref} className={`${className} transition-opacity duration-1000 ease-in ${isVisible ? 'opacity-100' : 'opacity-0 translate-y-5'}`}>
            {children}
        </section>
    );
};
...
export default function App() {
    ...
    const portfolioData = {
            ...
            highlights: [
                {
                    ...
                    description: "Mengubah ide menjadi produk jadi, dari desain antarmuka hingga logika backend yang kompleks.",
                },
                {
                    icon: "PuzzleIcon",
                    title: "Pemecah Masalah",
                    description: "Menikmati tantangan untuk menemukan solusi yang bersih dan efisien untuk masalah teknis yang rumit.",
                },
                {
                    icon: "HandshakeIcon",
                    title: "Terbuka untuk Kolaborasi",
                    description: "Aktif mencari peluang freelance, posisi full-time, dan kolaborasi dalam proyek open source.",
                },
            ],
        },
        contact: {
        ...
        skills: [
            { category: "Bahasa Pemrograman", items: ["JavaScript", "PHP"] },
            {
                category: "Frontend",
        ...
        projects: [
            {
                ...
                challenge:
                    "Tantangannya adalah membangun antarmuka yang responsif dan cepat untuk menampilkan banyak gambar tanpa mengorbankan performa, serta mengelola autentikasi pengguna untuk fitur unggah dan komentar.",
                ...
                <main className="container mx-auto px-6 py-12 pt-24 md:py-20 md:pt-32">
                    ...
                    >
                        <div className="md:w-3/5 text-center md:text-left mt-10 md:mt-0">
                            ...
                            <h2 className="text-xl md:text-2xl font-light text-purple-300 mb-6 h-14 md:h-16">
                                            ...
                                            >
                                                <img
                                                    ...
                                                    onError={(e) => {
                                                        ...
                                                        target.onerror = null;
                                                        target.src = "https://placehold.co/600x400/1a202c/9f7aea?text=Image+Not+Found";
                                                    }}
                                                />
                                            </a>
                                        </div>
                ...
                <footer className="text-center py-8 mt-16 md:mt-24">
                    ...
                    <div className="border-t border-gray-800 pt-6 mt-16">
                        <p className="text-gray-500">
                            Didesain dan Dibangun oleh Raditya Armanda &copy;{" "}
